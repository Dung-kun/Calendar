import 'package:calendar_project/utils/lunar_solar_utils.dart';
...
void onDaySelected(DateTime selectedday, DateTime focusedday) {
  if (!isSameDay(selectedDay, selectedday)) {
      ...
      var listlunar = convertSolar2Lunar(selectedday.day, selectedday.month, selectedday.year, 7);
      selectedlunar.value = new DateTime(listlunar[2], listlunar[1], listlunar[0]);
